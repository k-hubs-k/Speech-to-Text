...
audio_path = "../res/datasets/audio_train/"
...
i = 0  # indexe de la valeur actuelle dans la transcription
...
for audio_file in os.listdir(audio_path):
    if audio_file.endswith(".wav"):
        ...
        resultats.append({"audio_file": file_path, "transcription": transcription})
        i += 1


output_file = "../res/datasets/labels/audio_path.json"
